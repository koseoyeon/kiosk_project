...
public class RequestController {
	...
	public void salesSelectAllByAdminAndDate(int admin_id) {
		...
		mainFrame.clientThread.send(jsonObject.toString());
		System.out.println("salesSelectAllByAdminAndDate 요청 완료");
	}
	...
	public void salesRegist(OrderSummary orderSummary, List<OrderDetail> orderDetailList) {
		System.out.println("클라이언트로부터 받은 orderSummary_id : "+orderSummary.getOrder_price());
		System.out.println("클라이언트로부터 받은 orderDetailList : "+orderDetailList.size());
