...
public class LoginForm extends JDialog {
	...
	public void responseResult(JSONObject jsonObject) {
		...
		if ((boolean) jsonObject.get("result")) {
			...
			mainFrame.container.sales.salesSelectAll();
			mainFrame.container.sales.thread.start();
			mainFrame.container.product.stockSelectAll();
			mainFrame.setTitle(admin.getName()+" 로그인");
			//System.out.println("로그인한 계정 : "+mainFrame.getAdmin().getName());
			flag = true;
			setVisible(false);
